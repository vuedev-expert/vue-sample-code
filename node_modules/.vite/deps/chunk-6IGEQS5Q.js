      ...
      K(g, "Core/Animation/Fx.js", [
        ...
        return function() {
          ...
          a2.prototype.run = function(r, l, e) {
            ...
            r !== l || this.elem["forceAnimate:" + this.prop] ? (this.startTime = +new Date(), this.start = r, this.end = l, this.unit = e, this.now = this.start, this.pos = 0, m.elem = this.elem, m.prop = this.prop, m() && 1 === a2.timers.push(m) && k(p)) : (delete h.curAnim[this.prop], h.complete && 0 === Object.keys(h.curAnim).length && h.complete.call(this.elem));
          };
...
//# sourceMappingURL=chunk-6IGEQS5Q.js.map
